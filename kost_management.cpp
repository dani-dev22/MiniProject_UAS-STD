    ...
    for (int lantai=1;lantai<=4;lantai++) {
        ...
        for (int i=0;i<totalKamar;i++) {
            ...
            cout << "  " << setw(8) << k->nomorKamar
                 ...
                 << "Rp" << fixed << setprecision(0) << k->sewaBulanan << "\n";
        }
    }
    cout << "\n";
}
    ...
    for (int lantai=1;lantai<=4;lantai++) {
        ...
        for (int i=0;i<totalKamar;i++) {
            ...
            cout << "  " << setw(10) << k->nomorKamar
                 << setw(16) << tipeStrPendek(k->tipe)
                 << "Rp" << setw(14) << fixed << setprecision(0) << k->sewaBulanan
                 << "Rp" << k->deposit << "\n";
            ada=true;
        }
...
void tampilkanRiwayatTransaksi() {
    ...
    while (curr) {
        cout << "  " << setw(7) << curr->data.id
             ...
             << "Rp" << setw(12) << fixed << setprecision(0) << curr->data.jumlah
             << curr->data.tanggal << "\n";
        curr=curr->next;
    }
    cout << "\n";
...
void penghunIMasuk() {
    ...
    cout << "  Sewa/Bln    : Rp" << fixed << setprecision(0) << k->sewaBulanan << "\n";
    cout << "  Deposit     : Rp" << k->deposit << "\n";
    cout << "  Bayar Awal  : Rp" << totalBayarAwal << " (deposit + sewa bln 1)\n";
    cout << "  +----------------------------------------------------------+\n";
}
...
void penghunIKeluar() {
    ...
    cout << "  Deposit dikembalikan: Rp" << fixed << setprecision(0) << k->deposit << "\n";
    ...
    cout << "  [OK] Penghuni " << nama << " berhasil keluar dari Kamar "
         << nomorKamar << ".\n";
    cout << "  Deposit Rp" << fixed << setprecision(0) << k->deposit << " dikembalikan.\n";
}
...
void bayarSewa() {
    ...
    pushLog("BAYAR", nomorKamar,
            k->namaPenghuni + " | " + bulan + " | Rp" + to_string((long long)total));
    ...
    cout << "  Bulan     : " << bulan << "\n";
    cout << "  Sewa      : Rp" << fixed << setprecision(0) << k->sewaBulanan << "\n";
    cout << "  Listrik   : Rp" << listrik << "\n";
    cout << "  TOTAL     : Rp" << total << "\n";
    cout << "  +----------------------------------------------------------+\n";
}
